...
public class CD {
	...
	@Override
	public int hashCode() {
		return Objects.hash(getId(), getCdType(), getSinger(), getNumberOfSong(), getPrice());
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CD other = (CD) obj;
		return Objects.equals(cdType, other.cdType) && id == other.id && numberOfSong == other.numberOfSong
